    ...
    <form action="ServletAccesoDA" method="post">
        ...
        <div class="col">
            <table>
                <tr>
                    <td>DATO1:</td>
                    <td><input type="number" min="0" name="dato1"></td>
                </tr>
                <tr>
                    <td>DATO2:</td>
                    <td><input type="number" min="0" name="dato2"></td>
                </tr>
                <tr>
                    <td>DATO3:</td>
                    <td><input type="number" min="0" name="dato3"></td>
                </tr>
                <tr>
                    <td>DATO4:</td>
                    <td><input type="number" min="0" name="dato4"></td>
                </tr>
                <tr>
                    <td>DATO5:</td>
                    <td><input type="number" min="0" name="dato5"></td>
                </tr>
                <tr>
                    <td>DATO6:</td>
                    <td><input type="number" min="0" name="dato6"></td>
                </tr>
            </table>
