...
public class JSONReaderWriter {
	...
	private static final String PATH = ResourceExporter.ROOT_LOCATION + "DatosAbiertosJSON.json";
	...
	public static ArrayList<Dato> read() throws Exception {
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			Dato o = new Dato(String.valueOf(jsonObj.getInt("Año")), String.valueOf(jsonObj.getInt("Número de plazas")),
